...
export function assert(value: {} | [] | string | number | undefined, message: string): asserts value;
export function assert<TError extends { new (message?: string, ...args: any[]): Error } = typeof Error>(
  value: any,
  errorType: TError,
